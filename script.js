...
const pL1 = document.getElementById("name--0");
const pL2 = document.getElementById("name--1");
...
holdBtn.addEventListener("click", function () {
  if (playing) {
    ...
    if (scores[activePlayer] >= 20) {
      ...
      const winningPlayer =
        activePlayer === 0 ? pL1.textContent : pL2.textContent;
      document.querySelector(
        ".modal h1"
      ).textContent = `${winningPlayer} wins !🥳`;
      document
